package com.example.databaseapp.login
...
import com.example.databaseapp.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        loginViewModel.navigatetoChangePass.observe(this, Observer { hasFinished ->
            if(hasFinished == true)
            {
                navigateChangePass()
                loginViewModel.doneNavigatingChangePass()
    ...
    private fun navigateChangePass()
    {
